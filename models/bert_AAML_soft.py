...
class bert_AAML_soft(base_bert):
    def __init__(self,opt):
        super().__init__(opt)
        self.adms_loss = AngularPenaltySMLossWithSoftLabel(36,self.opt.polarities_dim[opt.dataset], loss_type='arcface',s=opt.s,m=opt.m,k=opt.k).to(self.device)
